...
interface ClipDao {
    ...
    @Query("SELECT * FROM clip_history WHERE copiedAt BETWEEN :start AND :end ORDER BY isPinned DESC, copiedAt DESC")
    fun searchByDateRange(start: Long, end: Long): Flow<List<ClipEntity>>
